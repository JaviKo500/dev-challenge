...
export const countSheep = () => {
  ...
  const filteredSheep = sheepList.filter( sheep => sheep.color === 'rojo' && (sheep.name.toLowerCase().includes('n') && sheep.name.toLowerCase().includes('a'))  );
